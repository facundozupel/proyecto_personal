...
- **URLs duplicadas o triplicadas** de categorías y subcategorías. O sea, Google veía tres versiones de la misma página y no sabía cuál indexar.
- Imágenes pesadas que hacían que el sitio cargara lento. Tedioso para el usuario, peor para el bot.
- **100% de dependencia de canales de pago.** Si mañana cortabas Google Ads, las ventas caían a cero.
- Tráfico transaccional limitado por errores técnicos que nadie había diagnosticado.
- **Sin una estrategia de SEO definida.** Literalmente, ninguna.

El panorama era claro: el canal orgánico no solo no crecía, sino que mostraba una **tendencia bajista muy fuerte** a finales de 2024.

---

## El diagnóstico: por qué el canal orgánico se estaba muriendo

Acá es donde se pone entretenido, porque el problema no era solo técnico. Era estratégico.

¿Qué encontré cuando me metí en los datos? Un patrón clásico de canibalización SEO-SEM.
...
Es la gráfica de canibalización SEO-SEM más clara que he visto. Google Ads estaba comiéndose el tráfico que el canal orgánico ya tenía.

Sin intervención, la tendencia 2025 para orgánico se veía muy desfavorable. El canal iba a perder muchísima rentabilidad.
...
Okay, con el diagnóstico claro, la intervención se enfocó en tres pilares. Te explico cada uno.
...
¿Cómo lo logré? Básicamente tres cosas: optimización del sitemap para que Google descubriera todas las URLs, resolución de problemas de rastreo que bloqueaban al bot, y una arquitectura de URLs limpia sin duplicaciones. Nada mágico, pero sí tedioso de ejecutar sin un proceso ordenado.

### 2. Optimización técnica y de contenido

Acá fue resolver los dolores del [SEO técnico](/seo-tecnico): limpiar las URLs duplicadas, optimizar imágenes para que no mataran la velocidad de carga, y mejorar la arquitectura del sitio para que Googlebot pudiera rastrear todo sin problemas.
...
¿Por qué estas y no otras? Porque el [keyword research](/blog/keywords-research-guia) mostraba que tenían volumen de búsqueda, intención transaccional clara y competencia alcanzable. Pragmatismo puro.

---

## Los resultados: acá se pone gigantesco

Okay, esta es la parte que más disfruto. Vamos con los números.

### Visibilidad y posicionamiento

| Métrica | Resultado |
|---------|-----------|
| Páginas indexadas | De 25.000 a 301.000 **(+1.107%)** |
| Keywords en Top 3 | **+29,7%** |
| Keywords en Top 10 | **+72,7%** |
| Keywords en Top 20 | **+66,9%** |

+72,7% en keywords Top 10. Eso es pasar de que Google te ignore a que te ponga en la primera página para miles de búsquedas transaccionales.

### Tráfico y engagement

- **Tráfico transaccional:** +27,7% desde febrero y **+59,82% YoY**
- **CTR:** +0,8% desde febrero y +0,7% YoY
- **222 mil clics** totales
- **794 mil impresiones**
- **Posición media:** 1,6
...
|---------|-------|---------|-------------|
| Ítems únicos vendidos/mes | 630 | 2.553 | **+305%** |
| AOV (Valor medio del pedido) | 67€ | 74€ | **+10,1%** |
| Transacciones | - | - | **+63,6%** |
| Ingresos totales | - | - | **+80,1%** |

Esto es lo que más me importa. No hablamos de vanity metrics, hablamos de facturación real.

#### El CTR de productos subió de forma sostenida
...
¿Sabés cuál es el indicador que más me gusta de todo este proyecto? La cantidad de ítems únicos que generan ventas.
...
Esa diversificación del catálogo vendido es la prueba directa de que la indexación masiva funciona. Más páginas indexadas = más productos encontrables = más ventas.

#### Revenue vs productos únicos vendidos
...
#### AOV: más transacciones Y mayor valor por pedido
...
Para medir el verdadero impacto, hice un análisis contrafactual. Básicamente: ¿qué habría pasado si no hacíamos SEO? Comparé los resultados reales contra una proyección basada en la tendencia bajista que traía el canal orgánico.

**Transacciones 2025:**
- Proyección sin SEO: **14.000**
- Real con SEO: **21.000**
- **Transacciones adicionales: 7.000 (+50%)**

**Facturación 2025:**
- Proyección sin SEO: ~889.000€
- Real con SEO: **1.450.000€**
- **Facturación adicional: 561.000€ (+62%)**

Más de medio millón de euros que no existirían sin la estrategia SEO. Eso es retorno de inversión orgánica real, medible, verificable en Google Analytics.
...
¿Qué pasó con el update? Las keywords en Top 3 bajaron de 27K (marzo) a 18.2K (abril). Normal, es un Core Update. Pero la tendencia se recuperó y cerró noviembre en **24.8K (+29.7% YTD)**.

El crecimiento más fuerte se dio en Top 10, que pasó de 37.5K a **64.8K (+72.7% YTD)**, y en Top 20 con un salto de 45.5K a **75.9K (+66.9% YTD)**.

Sin el trabajo previo de indexación, difícilmente habríamos cerrado el año con estos crecimientos. El timing fue clave, pero el timing sin ejecución no sirve de nada.
...
*¿Tu ecommerce tiene miles de productos que Google no indexa? ¿Estás quemando presupuesto en Ads sin haber tocado tu SEO? [Hablemos de tu caso](/consultor-seo-chile) y te muestro qué oportunidades tiene tu sitio.*
